...
from modell_klasse import KrankenhausModell  # noqa: F401 – wird fuer joblib benoetigt

# ── Konstanten ────────────────────────────────────────────────────
DATA_PATH    = Path("analysetabelle.csv")
MODEL_PATH   = Path("modell_krankenhaus.pkl")
